...
import camasir1 from "../assets/camasir1.jpg";
import camasir2 from "../assets/camasir2.jpg";

export default function Camasir() {
  useEffect(() => {
        ...
        <div className="bg-white p-[17px] rounded-lg  border-2 border-black text-justify">
          <p className="indent-6 ">
            <span className="font-semibold">
              Çamaşır makinesi tamiri konusunda uzmanız.
            </span>{" "}
            Müşterilerimizin çeşitli marka ve modellerdeki çamaşır makinelerinde
            karşılaştığı her türlü arıza ve sorunu çözmek için tecrübemiz ve
            uzman ekibimizle hizmet vermekteyiz. Ekipmanlarımızı sürekli güncel
            tutarak en son teknolojiye uygun araçlar ve ekipmanlar ile hizmet
            veriyoruz.
          </p>
          <p className="indent-6">
            {" "}
            Çamaşır makinesinin dönme sorunu Su akıtma problemleri Program
            hatası Tambur veya yatak problemleri Elektronik kart arızaları gibi
            konularda tamir ve bakım hizmeti sunmaktayız. Müşterilerimizin
            makine ile ilgili yaşadığı herhangi bir sorunla karşılaştığında bize
            ulaşmaları halinde öncelikle sorunu detaylı bir şekilde analiz
            ediyoruz. Ardından tecrübemiz ve uzmanlığımız doğrultusunda hızlı ve
            güvenilir bir şekilde çözüm üretiyoruz.
          </p>
          <p className="indent-6">
            Müşteri memnuniyetini en ön planda tutarak, hızlı, güvenilir ve
            kaliteli hizmet anlayışı ile çamaşır makinesi tamiri konusunda
            İstanbul genelinde en çok tercih edilen firmalar arasında yer
